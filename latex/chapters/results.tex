...
\subsection{Case Study Comparisons (SA vs GA vs ACO)}

We ran ten case studies with varying team sizes and step counts using the shared cost weights ($\alpha=3000$, $\beta=500$, $\gamma=4.0$) except Case 8 ($\alpha=2000$, $\beta=300$). Each algorithm used its standard settings (SA and GA at their tuned defaults; ACO with AS strategy from A1). Convergence plots are saved under \texttt{Figures/case\_study\_\{1..10\}\_comparison.png}.

\begin{table}[H]
\centering
\caption{Case Study Results Across SA, GA, and ACO}
\begin{tabular}{@{}lccccccccc@{}}
\toprule
\textbf{Case} & \textbf{Robots} & \textbf{Steps} & \textbf{SA Cost} & \textbf{GA Cost} & \textbf{ACO Cost} & \textbf{SA Cov (\%)} & \textbf{GA Cov (\%)} & \textbf{ACO Cov (\%)} & \textbf{Iters} \\
\midrule
1 & 6 & 125 & 15.2118 & 14.2329 & \textbf{11.3218} & 60.00 & 66.50 & \textbf{91.50} & 200 \\
2 & 4 & 100 & 27.5861 & 22.5629 & \textbf{11.6971} & 35.50 & 47.50 & \textbf{71.75} & 150 \\
3 & 3 & 50  & 62.2327 & 60.0123 & \textbf{11.5823} & 19.75 & 19.75 & \textbf{54.00} & 100 \\
4 & 4 & 100 & 26.1269 & 20.2141 & \textbf{11.6649} & 39.00 & 50.00 & \textbf{73.75} & 300 \\
5 & 4 & 100 & 27.2941 & 23.1667 & \textbf{11.7073} & 39.75 & 43.75 & \textbf{67.00} & 150 \\
6 & 4 & 100 & 28.1506 & 21.2091 & \textbf{11.9577} & 36.75 & 50.75 & \textbf{65.25} & 150 \\
7 & 4 & 100 & 26.6599 & 21.0870 & \textbf{11.7282} & 41.00 & 49.00 & \textbf{71.75} & 150 \\
8 & 4 & 100 & 27.6028 & 19.6376 & \textbf{11.7149} & 37.75 & 52.50 & \textbf{65.25} & 150 \\
9 & 4 & 100 & 27.3795 & 23.0067 & \textbf{11.8872} & 38.25 & 42.75 & \textbf{70.25} & 150 \\
10 & 2 & 100 & 54.4752 & 56.2474 & \textbf{11.9127} & 22.75 & 19.25 & \textbf{47.25} & 150 \\
\bottomrule
\end{tabular}
...
Across all ten case studies ACO delivered the lowest cost and highest coverage, often by large margins (e.g., Case 1: 91.50\% vs 66.50\% GA and 60.00\% SA). GA consistently outperformed SA on both cost and coverage, but both lagged behind ACO, especially in smaller teams (Cases 3 and 10) where ACO’s pheromone/heuristic guidance drove markedly better dispersion. Longer runs (Case 4 with 300 iterations) continued to favor ACO, suggesting that the pheromone map converges to high-quality paths even with extended horizons.
